		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "consequence.0.params", `{"automaticFacetFilters":[{"facet":"category","disjunctive":true,"score":0}]}`),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "consequence.0.params", `{"query":{"edits":[{"type":"remove","delete":"tag"}]},"automaticFacetFilters":[{"facet":"tag","disjunctive":true,"score":0}]}`),
